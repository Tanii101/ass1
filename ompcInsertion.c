...
void parallel_smallest_sum_insertion(double **distance_matrix, int num_coords, int *tour) {
...
int main(int argc, char *argv[]) {
    ...
    parallel_smallest_sum_insertion(distance_matrix, num_coords, tour);
